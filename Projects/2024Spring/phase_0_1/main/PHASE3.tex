...
همچنین برای انتخاب جایگاه موردنظر از \lr{Dip switch} ها استفاده کنید و برای مشخص کردن تعداد اجناس قرار داده شده در جایگاه انتخاب شده از ۲ \lr{Push button} بُرد استفاده کنید. یکی از \lr{Push button} ها بالا شمار و دیگری پایین شمار فرض شود. برای راحتی فرض‌های زیر انجام شود:
...
\textbf{نکته مهم:} \lr{Push button} های موجود بر روی بُرد، \lr{debounce} نشده است. بنابراین نیاز این موضوع برای عملکرد صحیح سیستم درنظر گرفته شود\footnote{برای اطلاعات بیشتر می‌توانید \href{https://www.geeksforgeeks.org/switch-debounce-in-digital-circuits/}{\textcolor{magenta}{اینجا}} را بخوانید}
...
پس از انتخاب کاربر، موجودی آن باید بر روی \lr{Seven segment} نمایش داده شود. پس از انتخاب کالای مورد نظر و تایید خرید (با استفاده از \lr{Push button}) درصورت داشتن موجودی کافی در حساب کاربر و دستگاه، خرید با موفقیت انجام می‌شود و مانده حساب آپدیت شده و نمایش داده می‌شود.
